...
requestItemsColumn.addEventListener("click", deleteInquiryItem);
...
function deleteInquiryItem(e) {
    ...
    if (deleteInquiryBtn == e.target) {
        ...
        for (i = 0; i < dataRequestedItemFromLocalStorage.length; i++) {
            if (inquiryDeleteItemNumber == dataRequestedItemFromLocalStorage[i].itemNumber) {
                dataRequestedItemFromLocalStorage.splice([i], 1);
            }
        }
        ...
        let dataRequestedItemFromLocalStorageJSON = JSON.stringify(dataRequestedItemFromLocalStorage);
        localStorage.setItem("requestedItemtoStorage", dataRequestedItemFromLocalStorageJSON);
